# LeetCode-Journey
365 Days to Google - Day 1 se start.  Ex-Tata Steel → Self-taught Python Developer.  Daily LeetCode + Interview Prep Log
# LeetCode-Journey
**365 Days to Google - Day 1 se start** 🚀

Ex-Tata Steel → Self-taught Python Developer
7th class se coding | Dec 2026: Google Loading...

### Progress Log
| Day | Question | Topic | Link |
| --- | --- | --- | --- |
